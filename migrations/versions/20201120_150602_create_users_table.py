...
def upgrade():
    ...
    op.create_table('transactions',
                    ...
                    sa.Column('transaction_date', sa.DateTime(), nullable=True, default=sa.func.current_timestamp()),
    ...
    op.create_table('orders',
                    ...
                    sa.Column('order_date', sa.DateTime(), nullable=True, default=sa.func.current_timestamp()),
